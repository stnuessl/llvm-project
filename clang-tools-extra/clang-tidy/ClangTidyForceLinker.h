...
// This anchor is used to force the linker to link the MisracModule.
extern volatile int MisracModuleAnchorSource;
static int LLVM_ATTRIBUTE_UNUSED MisracModuleAnchorDestination =
    MisracModuleAnchorSource;
