...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_MISC_NOUNIONCHECK_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_MISC_NOUNIONCHECK_H
...
#endif // LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_MISC_NOUNIONCHECK_H
