...
static const uint8 Swc_Var13 = 0;
// CHECK-MESSAGES: [[@LINE-1]]:20: warning: invalid mapping of const variable 'Swc_Var13' to 'VAR' section [autosar-memory-mapping]
// CHECK-MESSAGES: [[@LINE-5]]:9: note: section started with 'Swc_START_SEC_VAR_INIT_8' here
// CHECK-MESSAGES-MOD: [[@LINE-3]]:20: warning: invalid mapping of const variable 'Swc_Var13' to 'VAR' section [autosar-memory-mapping]
// CHECK-MESSAGES-MOD: [[@LINE-7]]:9: note: section started with 'Swc_START_SEC_VAR_INIT_8' here
